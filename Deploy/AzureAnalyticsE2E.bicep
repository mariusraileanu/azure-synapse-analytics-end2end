...
param ctrlDeployDatabricks bool = true //Control for creation of Databricks
...
param databricksWorkspaceName string = 'azdb${uniqueSuffix}'

@description('Databricks Managed Resource Group Name')
param databricksManagedResourceGroupName string = '${databricksWorkspaceName}-mrg'
...
param databricksPricingTier string = 'standard'
...
module m_DatabricksDeploy 'modules/DatabricksDeploy.bicep' = if (ctrlDeployDatabricks == true){
